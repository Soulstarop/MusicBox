...
use MusicBox\NoteBoxAPI;

class MusicBox extends PluginBase implements Listener{
	...
	public function onEnable(){
		...
		$this->getServer()->getPluginManager()->registerEvents($this,$this);
		if(!$this->CheckMusic()){
			$this->getLogger()->info("Please put in nbs files!!!");
		}else{
			$this->StartNewTask();
		}
...
class MusicPlayer extends PluginTask{
    ...
    public function __construct(MusicBox $plugin){
